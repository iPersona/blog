...
pub use util::{get_identity_and_web_context, Permissions, RedisPool, WebContext};
...
pub struct AppState {
    pub db: Addr<crate::util::postgresql_pool::DataBase>,
    pub cache: Addr<crate::util::redis_pool::Cache>,
}
