...
<script>
  ...
  import DismissedAlert from './DismissedAlert'
  ...
  export default {
    ...
    watch: {
      ...
      contentText: function (newVal, oldVal) {
        ...
        let isModified = (newVal !== this.contentTextBackup);
        ...
        // let isMdy = (newVal !== this.contentTextBackup);
        // console.log("args.isModified=" + isMdy);
        // if (isMdy === true) {
        //   console.log("oldtxt: " + this.contentTextBackup);
        //   console.log("newtxt: " + newVal);
        // }
    ...
    methods: {
      ...
      validate() {
        try {
          ...
          this.$refs.alert.showMsg("This is a valid JSON");
          return jsonObj;
        } catch (e) {
          let msg = e.message;
      ...
      async save() {
        ...
        try {
          ...
          console.log("rsp: " + rsp);
          this.$refs.alert.showMsg("File is successfully saved!");
          ...
          this.$refs.alert.showError("Save failed: " + error.message);
        }
      },
      saveFile() {
